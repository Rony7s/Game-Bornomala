       ...
       const imgBox =[
        ...
        function drawFood() {
            ctx.font = "35px";
            ctx.fillStyle = "red";
            ctx.drawImage(imgBox[score], 0, 0, 500, 550);
            ctx.fillText(alphabet[score], foodX+25, foodY+40);
...
//=============================================================== after eat
        function alpha(index, w, h) {
            ...
            ctx.fillStyle = "black";
            if (index > 2) {
                ctx.fillText(alphabet[index - 3], w+25, h+40);
            } else {
...
//Rajshahir am
        function welcome() {
            ...
            ctx.fillStyle = "green";
            ctx.textAlign = "center";
            ctx.fillText("Welcome to রাজশাহীর আম", gameWidth / 2, gameHeight / 2);
            running = false;
        };
